...
nexttile
hold on
plot(t,CREF(:,18,3)) % Drown
plot(t,CREF(:,12,10)) % Erode
plot(t,CREF(:,5,5)) % Stable
plot(t,CREF(:,1,5)) % Fill
...
nexttile
hold on
plot(t,MTOT(:,18,3)) % Drown
plot(t,MTOT(:,12,10)) % Erode
plot(t,MTOT(:,5,5)) % Stable
plot(t,MTOT(:,1,5)) % Fill
